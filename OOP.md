...
+ `static` - это то, что принадлежит самому классу, а не его экземплярам (объектам). (лежат прямо на конструкторе (на самом классе)) 

То есть не обязательно создавать объект
